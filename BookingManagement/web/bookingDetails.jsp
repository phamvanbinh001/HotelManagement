                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating date" id="date3" data-target-input="nearest">
                                            <input type="date" class="form-control datetimepicker-input" id="checkin" name="checkinDate" placeholder="Check In" data-target="#date3" data-toggle="datetimepicker" required />
